...
DEFAULT_CATALOG = [
    ...
    # Source: docs.anthropic.com/en/docs/about-claude/models/all-models (2026-03-17)
    ...
    # Source: platform.openai.com/docs/models + user-verified Codex CLI screen (2026-03-17)
